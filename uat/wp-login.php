...
<?php   }
	...
	{
		var msg_div = document.getElementById('login_error').innerHTML;
	
		if(msg_div.indexOf('Registration confirmed') !=-1 || msg_div.indexOf('Unexpected confirmation') !=-1)
		{
			window.location.href = 'http://uat.adviservoice.com.au/subscribe/';	
		}
	}
</script>";
		if ( !empty($messages) )
