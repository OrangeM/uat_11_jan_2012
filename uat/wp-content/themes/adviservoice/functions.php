...
function member_check_shortcode( $atts, $content = null ) {
    ...
    return 'We are sorry but these tools are for AdviserVoice members only. Please <a href="http://localhost/342/registration/">sign up</a> or <a href="http://localhost/342/wp-login.php?redirect_to='.$current_url.'" >sign in</a> to use them. Becoming a member is easy and free. Thank you!';
}
