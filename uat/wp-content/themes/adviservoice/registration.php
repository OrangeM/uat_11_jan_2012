...
if ( 'POST' == $_SERVER['REQUEST_METHOD'] && !empty( $_POST['action'] ) && $_POST['action'] == 'adduser' ) {
	...
	elseif ( email_exists($userdata['user_email']) )
		...
		wp_redirect("http://uat.adviservoice.com.au/thanksforregistration");
	}
...
<p style="margin-top:10px;"><a href="http://uat.adviservoice.com.au">Or click here to go back to the homepage.</a></p>

</div>

<div style="width:400px; float:right;">
<img class="alignnone no-border marginB_20" title="AdviserVoice newsletters" src="http://uat.adviservoice.com.au/wp-content/uploads/stateofplay/AVmail-square.png" alt="AdviserVoice newsletters" width="400" height="400" />
</div>
