...
function mytheme_add_admin() {
    ...
    add_theme_page($themename." Options", "Buddymatic Options", 'edit_themes', basename(__FILE__), 'mytheme_admin');
...
<p><?php _e('For more information about this theme, <a href="http://freebpthemes.com">visit Free BP Themes</a>.'); ?></p>
</div>
<?php
}
