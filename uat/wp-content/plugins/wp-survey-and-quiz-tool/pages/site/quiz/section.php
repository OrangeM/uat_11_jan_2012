...
?>
<a name="test"></a><h1><?php echo stripslashes($_SESSION['wpsqt'][$quizName]['sections'][$sectionKey]['name']); ?></h1>
<?php endif; 
...
<?php else: ?><a name="test"></a>
	<input type="hidden" id="quiz_check" name="quiz_check" value="1">
	<input type='submit' value='Start quiz' id="start_quiz" class='button-secondary' style='margin-left: 10px;' />
<?php endif; ?>
</form>
</div>
